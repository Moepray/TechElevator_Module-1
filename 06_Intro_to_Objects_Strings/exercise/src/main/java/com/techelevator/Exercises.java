...
public class Exercises {
	...
	public String makeOutWord(String out, String word) {
		String wordInTheMiddle = (out.substring(0, 2) + word + out.substring(2, 4));
		return wordInTheMiddle;
	...
	public String extraEnd(String str) {
		...
		String last2Chars = str.substring(str.length() - 2) + str.substring(str.length() - 2) + str.substring(str.length() - 2);
		return last2Chars;
	}
	...
	public String right2(String str) {
		String right2 = str.substring( (str.length() -2), str.length()) + str.substring(0, (str.length() -2));
		return right2;
	}
	...
	public String theEnd(String str, boolean front) {
		if (front) {
			String theFront = str.substring(0, 1);
			return theFront;
		}else{
			String theEnd = str.substring((str.length() - 1) ,str.length());
			return theEnd;
		}
	...
	public String twoChar(String str, int index) {
		...
		if (index >= 0 && (index + 2 <= stringLength)) {
	 ...
	 */
		public String middleThree (String str){
			String TheMiddleThree = str.substring(((str.length() / 2) - 1), ((str.length() / 2) + 2));

			return TheMiddleThree;
		}
	...
	public String frontTimes(String str, int n) {
		...
		if (str.length() == 0){
			...
			for (int i = 0; i < n; i++){
				frontTimes = frontTimes + str.substring(0, 1);
			}
		} else if (str.length() == 2){
			for (int i = 0; i < n; i++){
				frontTimes = frontTimes + str.substring(0, 2);
			}
		} else {//(str.length() >= 3){
			for (int i = 0; i < n; i++){
				frontTimes = frontTimes + str.substring(0, 3);
			}
		}
		return frontTimes;
	}
	...
	public boolean doubleX(String str) {
		for (int i = 0; i < (str.length() -1); i++){
			if (str.substring(i, i + 1).equals("x") && (str.substring(i, (i + 2)).equals("xx"))){
	...
	public String stringBits(String str) {
		...
		for (int i = 0; i < str.length(); i = i + 2){
			stringBits = stringBits + str.substring(i, i + 1);
		}
		return stringBits;
	}
